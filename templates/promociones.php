...
<section class="template-section" id="promo">

    <div class="container">
        
        <div class="center">
            <h1 class="big noodle navy">SALTOS EN PARACAÍDAS EN TEQUESQUITENGO MORELOS</h1>
        </div>
...
<section class="skew twhite skew-cc mov-hid">
...
<section id="why1s" class="skew orangebot-sk skew-cc mov-hid">
...
<section class="skew orangesk skew-cc mov-hid">
